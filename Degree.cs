...
namespace Geographics
{
    ...
    public struct Degree : IComparable<Degree>
    {
        ...
        public override string ToString() { return $"{Value:F4}°"; }

        public int ToE6Int() { return (int)(Value * 1e6); }

        public static Degree FromE6Int(int Value) { return new Degree(Value * 1e-6); }
    }
}
